...
from visualise import plot_species, draw_net, plot_stats
import pickle

env = gym.make('SpaceInvaders-v0')
#To record in particular episodes
env = gym.wrappers.Monitor(env, "recording_image",video_callable=lambda episode_id: episode_id%50==0, force=True)
...
#evalutes genomes based on their fitness scores
    for genome_id,genome in genomes:
        ...
        print('Genome: ',genome_id,' Fitness: ',fitness,' Killed:',aliens_dead)
        if fitness==None:
            fitness =0
...
#p = neat.Checkpointer.restore_checkpoint('./saved_models_image/neat-checkpoint-190')
